...
@Preview("collection screen nav rail", device = Devices.PIXEL_C)
@Preview("collection screen nav rail (dark)", uiMode = Configuration.UI_MODE_NIGHT_YES, device = Devices.PIXEL_C)
@Preview("collection screen nav rail (big font)", fontScale = 1.5f, device = Devices.PIXEL_C)
@Composable
fun PreviewCollectionScreenNavRail() {
    MagicTheme {
